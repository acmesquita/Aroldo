...
class QuadrasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quadra" do
    assert_difference('Quadra.count') do
      post quadras_url, params: { quadra: { descricao: @quadra.descricao, geom: @quadra.geom } }
    end
  ...
  test "should update quadra" do
    patch quadra_url(@quadra), params: { quadra: { descricao: @quadra.descricao, geom: @quadra.geom } }
